...
;!function (e, t) {
    ...
    var i, n, a = e.layui && layui.define, o = {
        ...
        v: "3.1.1", ie: function () {
            ...
            return e = e || {}, r.cache = o.config = i.extend({}, o.config, e), r.path = o.config.path || r.path, "string" == typeof e.extend && (e.extend = [e.extend]), o.config.path && r.ready(), e.extend ? (a ? layui.addcss("modules/layer/" + e.extend) : o.link("/static/goods/css/" + e.extend), this) : this
        }, ready: function (e) {
            var t = "layer", i = "", n = (a ? "modules/layer/" : "/static/") + "goods/css/layer.css?v=" + r.v + i;
